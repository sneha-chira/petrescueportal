...
urlpatterns = [
    ...
    # Use custom-admin prefix to avoid Django admin conflicts
    path('custom-admin/approve-request/<int:pk>/', views.approve_adoption_request, name='approve_adoption_request'),
    path('custom-admin/reject-request/<int:pk>/', views.reject_adoption_request, name='reject_adoption_request'),
]
