...
def approve_adoption_request(request, pk):
    ...
    pet_name = pet.name if pet.name else pet.breed
    messages.success(request, f'Adoption request for {pet_name} has been approved!')
...
def reject_adoption_request(request, pk):
    ...
    pet_name = adoption_request.pet.name if adoption_request.pet.name else adoption_request.pet.breed
    messages.success(request, f'Adoption request for {pet_name} has been rejected.')
